...
with_node --no-warnings --eval "require('expo-modules-autolinking')(process.argv.slice(1))" generate-package-list  --target "/Users/ismael.leiva/repos/github/ai-farma-app/ios/Pods/Target Support Files/Pods-AIFarma/ExpoModulesProvider.swift"
